...
const WS_VOICE_URL = typeof window !== 'undefined' ? getWsVoiceUrl() : `${(process.env.NEXT_PUBLIC_PYTHON_BACKEND_URL || 'http://136.111.252.120:8000').replace('https://', 'wss://').replace('http://', 'ws://')}/ws/voice`;

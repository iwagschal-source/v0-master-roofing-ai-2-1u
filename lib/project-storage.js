...
function getStorageClient() {
  if (!storageClient) {
    ...
    // Option 1: Full JSON key (GOOGLE_APPLICATION_CREDENTIALS_JSON)
    ...
    // Option 2: Individual components (Vercel setup with GOOGLE_SERVICE_ACCOUNT_EMAIL + GOOGLE_PRIVATE_KEY)

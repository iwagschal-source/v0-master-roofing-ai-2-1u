...
export async function fillBluebeamDataToSpreadsheet(spreadsheetId, bluebeamItems, config = null) {
  ...
  if (config?.columns) {
    ...
    // Include both hyphenated and non-hyphenated versions (FL-1 and FL1)
    Object.assign(locationColumns, {
      // Column G - 1st Floor / Main Roof
      '1ST FLOOR': 'G', 'FIRST FLOOR': 'G', 'FL1': 'G', 'FL-1': 'G',
      'MAIN ROOF': 'G', 'MR': 'G', 'ROOF': 'G',
      // Column H - 2nd Floor / Bulkhead
      '2ND FLOOR': 'H', 'SECOND FLOOR': 'H', 'FL2': 'H', 'FL-2': 'H', 'BULKHEAD': 'H', 'BH': 'H',
      // Column I - 3rd Floor
      '3RD FLOOR': 'I', 'THIRD FLOOR': 'I', 'FL3': 'I', 'FL-3': 'I',
      // Column J - 4th Floor
      '4TH FLOOR': 'J', 'FOURTH FLOOR': 'J', 'FL4': 'J', 'FL-4': 'J',
      // Column K - Penthouse / Elevator
      'PENTHOUSE': 'K', 'PH': 'K', 'ELEV': 'K', 'ELEVATOR': 'K',
      // Column L - Mechanical
      'MECHANICAL': 'L', 'MECH': 'L',
      // Column M - Elevator Bulkhead
  ...
  // This ensures CSV codes can find their row even if Column A is empty
  // Includes BOTH full codes (MR-006IRMA) AND short codes (IRMA) for legacy parsing
  const SCOPE_CODE_TO_NAME = {
    // Full codes from lib_takeoff_template
    ...
    // SHORT CODES for legacy parsing mode (from ITEM_PATTERNS in bluebeam route)
    'VB': 'VAPOR BARRIER',
    'PITCH': 'PITCH UPCHARGE',
    'ROOF-2PLY': 'ROOFING - 2 PLY',
    '2PLY': 'ROOFING - 2 PLY',
    'UP-OVER': 'UP AND OVER',
    'SCUPPER': 'SCUPPER/LEADER',
    'IRMA': 'ROOFING - IRMA',
    'PMMA': 'PMMA @ BUILDING',
    'PMMA-BLDG': 'PMMA @ BUILDING',
    'PMMA-PAR': 'PMMA @ PARAPET',
    'DRAIN': 'DRAINS',
    'DOOR-STD': 'DOORPANS - STD',
    'DOOR-LG': 'DOORPANS - LARGE',
    'HATCH': 'HATCH/SKYLIGHT (SF)',
    'MECH-PAD': 'MECH PADS',
    'PAD': 'MECH PADS',
    'FENCE': 'FENCE POSTS',
    'RAIL': 'RAILING POSTS',
    'PLUMB': 'PLUMBING PEN.',
    'MECH-PEN': 'MECHANICAL PEN.',
    'DAVIT': 'DAVITS',
    'AC': 'AC UNITS/DUNNAGE',
    'PTAC': 'AC UNITS/DUNNAGE',
    'COPE': 'COPING (LOW)',
    'COPE-LO': 'COPING (LOW)',
    'COPE-HI': 'COPING (HIGH)',
    'FLASH': 'FLASH @ BUILDING',
    'FLASH-BLDG': 'FLASH @ BUILDING',
    'FLASH-PAR': 'FLASH @ PARAPET',
    'OVERBURDEN': 'OVERBURDEN IRMA',
    'BALLAST': 'OVERBURDEN IRMA',
    'PAVER': 'PAVERS',
    'GREEN': 'GREEN ROOF',
    'TURF': 'GREEN ROOF',
    'LIQUID-WP': 'RECESSED FLOOR WP',
    'RECESS-WP': 'RECESSED FLOOR WP',
    'TRAFFIC': 'TRAFFIC COATING',
    'DRIP': 'ALUM. DRIP EDGE',
    'LFLASH': 'LIQUID L FLASH',
    'DOOR-BAL': 'DOORPANS - BALC.',
    'BRICK': 'BRICK WP',
    'PANEL': 'PANEL WP',
    'EIFS': 'EIFS',
    'STUCCO': 'TRANS. STUCCO',

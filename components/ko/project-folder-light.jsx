 ...
 *   thirdLogo?: string,
 *   onClick?: () => void
 * }} ProjectFolderLightProps
 */

/**
 * Project folder card component (light theme variant)
 * @param {ProjectFolderLightProps} props
 */
export function ProjectFolderLight({
  name,
  summary,
  status,
  isActive = false,
      ...
      <div className="relative mt-4">
        ...
        >
          ...
          <div className="flex min-h-[140px]">
            ...
            {/* Right Side - Live Screen Panel (white with dark rim) */}
            <div className="w-[140px] p-2 flex flex-col">
              <div className="flex-1 bg-surface-elevated border-2 border-border rounded-md p-2 flex flex-col overflow-hidden shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)]">
                {/* Activity Indicator */}
                {isIngesting && (

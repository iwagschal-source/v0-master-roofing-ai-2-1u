...
import { Home, Settings, Sparkles, Bot, Shield, TrendingUp, Calculator, FolderKanban, Building2, Inbox } from "lucide-react"
...
export function NavigationRail({ activeMode, onModeChange, visible }) {
  const navItems = [
    ...
    { id: "contacts", icon: Building2, label: "Contacts", type: "lucide" },
